        ...
        static void Main(string[] args)
        {
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = "C:\\Users\\HP\\Phase2_Section8_SearchAndSort\\StudentData1.txt";
                    ...
                    // Write to file
                    File.WriteAllLines("C:\\Users\\HP\\Phase2_Section8_SearchAndSort\\StudentData2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    // Write to file
                    File.WriteAllLines("C:\\Users\\HP\\Phase2_Section8_SearchAndSort\\StudentData3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("C:\\Users\\HP\\Phase2_Section8_SearchAndSort\\StudentData1.txt").Split(' ');
